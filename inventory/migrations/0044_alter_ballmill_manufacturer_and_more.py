# Generated by Django 4.2.5 on 2023-12-27 21:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('inventory', '0043_ballmill_barcode_boringcutter_barcode_and_more'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='ballmill',
            name='manufacturer',
            field=models.CharField(choices=[('Unknown', 'Unknown'), ('ceratizit', 'Ceratizit'), ('guehring', 'Guehring'), ('hoffmann', 'Hoffmann'), ('tungaloy', 'Tungaloy'), ('sandvik', 'Sandvik'), ('walter', 'Walter'), ('duemmel', 'Duemmel'), ('phorn', 'Phorn'), ('skene järn', 'Skenejarn')], default='Unknown', max_length=50),
        ),
        migrations.AlterField(
