...
class ManufacturerSearchPage:
    MANUFACTURER_INFO = {
        ...
        Manufacturer.GUEHRING.value : {
            ...
            'barcode_xpath': '//*[@id="product-details"]/div/div[2]/div',
            'code_xpath': '//*[@id="product-details"]/div/div[1]/div',
            'picture_xpath': '//*[@id="gallery"]/div/div[1]/div/img[2]',
            'description_xpath': '//*[@id="product-name"]',
            },
        Manufacturer.CERATIZIT.value : {
            ...
            'cookie_button_xpath': "//a[@class='declineAllButtonLower']",
